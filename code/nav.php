...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="./" width="50px">
    <img class="d-inline-block align-top" src="./img/photofox-logo.png" width="30" height="30" alt="Logo"> Photofox</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item <?php if ($currentPage === 'user_overview') {
                            echo 'active';
                          } ?>">
    ...
    <ul class="navbar-nav mr-right">
      <li class="nav-item <?php if ($currentPage === 'acc_settings') {
                            echo 'active';
                          } ?>">
